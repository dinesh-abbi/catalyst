...
interface ExerciseCardProps {
    ...
    index: number;
    onTriggerRest?: (exerciseName: string, restDuration: string) => void;
}
            ...
            <View style={{ flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 20 }}>
                ...
                <View style={{ alignItems: 'flex-end' }}>
                    <TouchableOpacity
                        onPress={() => {
                            onToggleComplete();
                            if (!isCompleted && exercise.rest && onTriggerRest) {
                                onTriggerRest(exercise.name, exercise.rest);
                            }
                        }}
                ...
                <View style={{ flexDirection: 'row', flex: 1 }}>
                    ...
                    {exercise.rest && (
                        ...
                        >
                            ...
                            <Text style={{ color: isCompleted ? appTheme.colors.textTertiary : appTheme.colors.accent, fontFamily: appTheme.typography.fontFamily.monoBold, fontSize: 20 }}>
                                {exercise.rest}
                            </Text>
                        </TouchableOpacity>
                    )}
